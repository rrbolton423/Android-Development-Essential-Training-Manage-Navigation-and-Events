...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Use a Lambda expression to reduce boiler plate code and call
        // the runCode() method when the view is clicked
        runButton.setOnClickListener(view -> runCode());

        // Get an instance of the View class,
        // and use a Lambda expression to reduce boiler plate code and call
        // the clearLog() method when the view is clicked
